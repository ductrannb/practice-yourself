<template>
  <div class="admin-layout">
    <div class="navbar-wrapper">
      <router-link :to="{name: 'home'}" class="navbar-logo-box">
      ...
      <div class="navbar-menu-box">
        <router-link
            ...
            'navbar-menu-item--active': ['user.dashboard'].includes($route.name)
          }"
        ...
        <router-link
            :class="{
            'navbar-menu-item': true,
            'navbar-menu-item--active': ['user.dashboard.courses'].includes($route.name)
          }"
            :to="{name: 'user.dashboard.courses'}"
        >
        ...
        <router-link
            :class="{
            'navbar-menu-item': true,
            'navbar-menu-item--active': ['user.dashboard.exams'].includes($route.name)
          }"
            :to="{name: 'user.dashboard.exams'}"
        >

    ...
    >
      ...
      <template v-slot:[`item.actions`]="{ item }">
        <div class="admin-user-table--column-action-box">
          <v-icon icon="mdi-eye" @click="$router.push({name: 'admin.courses.lessons.questions.detail', params: {questionId: item.id}})"/>
          <v-icon icon="mdi-pencil" @click="$router.push({name: 'admin.courses.lessons.questions.update', params: {questionId: item.id}})"/>

  ...
  <div class="admin-user-wrapper">
    <div class="admin-container">
      ...
      <div class="admin-form-footer">
        <router-link
            :to="{name: 'admin.courses.lessons.questions', params: { id: this.$route.params.id, lessonId: this.$route.params.lessonId }}"
            class="admin-form-footer-btn admin-form-footer-btn--cancel"
        >
          Trở lại
        </router-link>
        <router-link
            :to="{name: 'admin.courses.lessons.questions.update'}"
